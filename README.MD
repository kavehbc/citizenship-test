...
## Run
In order to run this app, you need to install the dependencies first based on `environment.yml`.
...
[https://citizenship-test.streamlitapp.com/](https://citizenship-test.streamlitapp.com/)
